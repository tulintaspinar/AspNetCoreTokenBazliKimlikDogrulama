...
namespace UdemyAuthServer.Service.Services
{
    public class TokenService : ITokenService
    {
        ...
        public TokenDto CreateToken(UserApp userApp)
        {
            ...
            JwtSecurityToken jwtSecurityToken = new JwtSecurityToken(issuer: _tokenOption.Issuer, expires: accessTokenExpiration, notBefore: DateTime.Now,claims:GetClaims(userApp,_tokenOption.Audience),signingCredentials:signingCredentials);
